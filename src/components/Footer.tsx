...
const Footer = () => {
  const links = {
    forClients: ["How to Hire", "Talent Marketplace", "Project Catalog", "Enterprise"],
    forTalent: ["How to Find Work", "Find Freelance Jobs", "Win Work", "Freelance Resources"],
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-4">
              Connect with the world's best freelancers and get work done.
            </p>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm mb-4 md:mb-0">
            © 2025 ZeeWork. All rights reserved.
          </p>
